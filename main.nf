...
// (no gVCF merging)
// Assume each sample has exactly two FASTQ files (no multiple read groups per sample)
// The sample names and FASTQ files must be given in  samplesheet.csv file with header line "sample,fastq_1,fastq_2"
